    ...
    >
      <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-lg xl:max-w-xl lg:text-left bg-transparent">
        ...
        <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start bg-transparent">
          <a rel="noopener noreferrer" href="/activity" className="px-8 py-3 text-lg font-semibold rounded bg-violet-400 text-gray-900 hover:bg-violet-500  ">Track Workout</a>
