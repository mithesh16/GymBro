...
const Team = () => {
  return (
    <div class="bg-gray-900 pb-20">
      <div className='flex items-center justify-center mt-2 bg-gray-900'>
        <h1 className='text-violet-400 text-[35px] font-bold w-fit bg-gray-900  '>Meet Our Team</h1>
        </div>
    <div class="container mx-auto px-6 md:px-12 xl:px-32 bg-gray-900">
        ...
        <div class="flex justify-center items-center mt-12  text-center bg-gray-900">
