...
const SignUp = () => {
  ...
  return (
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm text-center">
      ...
      <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-white">Create a new account</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-3" onSubmit={()=>{
        ...
        <div>
          <button type="submit" class="flex w-full justify-center rounded-md bg-violet-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm  hover:bg-violet-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign Up</button>
        </div>
        <div>
          ...
          <FcGoogle className="lg:text-2xl text-xl mr-2 bg-transparent " /> Sign up with Gmail
          </button>
        </div>
      </form>
      ...
      <p class="mt-10 text-center text-md text-gray-500">
        Already a member? 
        <a href="/" class="font-semibold leading-6 text-violet-400 hover:text-violet-600"> Sign In</a>
      </p>
